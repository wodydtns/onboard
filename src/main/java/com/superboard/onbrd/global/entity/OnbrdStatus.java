...
public enum OnbrdStatus {
	...
	private static final OnbrdStatus[] VALUES;
	...
	public static OnbrdStatus valueOf(int statusCode) {
		OnbrdStatus status = resolve(statusCode);
		if (status == null) {
	...
	@Nullable
	public static OnbrdStatus resolve(int statusCode) {
		// Use cached VALUES instead of values() to prevent array allocation.
		for (OnbrdStatus status : VALUES) {
