...
public enum ExceptionCode {
	...
	NOT_SOCIAL_MEMBER(OnbrdStatus.NOT_SOCIAL_MEMBER, "NOT_SOCIAL_MEMBER"),

	MAIL_SENDING_FAILED(INTERNAL_SERVER_ERROR, "MAIL_SENDING_FAILED"),
	...
	NOTICE_NOT_FOUND(NOT_FOUND, "NOTICE_NOT_FOUND"),

	INQUIRY_NOT_FOUND(NOT_FOUND, "INQUIRY_NOT_FOUND"),

	REPORT_NOT_FOUND(NOT_FOUND, "REPORT_NOT_FOUND"),

	NOTIFICATION_NOT_FOUND(NOT_FOUND, "NOTIFICATION_NOT_FOUND"),
